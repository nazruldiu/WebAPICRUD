...
namespace WebAPIFullCRUDWithFile.DataService.Migrations
{
    ...
    [Migration("20220820104604_Update Users and Add Details")]
    partial class UpdateUsersandAddDetails
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebAPIFullCRUDWithFile.Entities.Entities.UserDetailsEntity", b =>
                {
                    ...
                    b.Property<int>("UserModelEntityId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("UserModelEntityId");

                    b.ToTable("UserDetailsEntity");
                });
            ...
            modelBuilder.Entity("WebAPIFullCRUDWithFile.Entities.Entities.UserDetailsEntity", b =>
                {
                    b.HasOne("WebAPIFullCRUDWithFile.Entities.Entities.UserModelEntity", "UserModelEntity")
                        .WithMany("UserDetailsEntities")
                        .HasForeignKey("UserModelEntityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("UserModelEntity");
                });
